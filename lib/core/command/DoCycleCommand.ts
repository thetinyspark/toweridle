...
export default class DoCycleCommand implements ICommand{
    ...
    private async _processCycle(facade: Facade, bf:BattleField, numCycle:number):Promise<GameOverInfoType>{
        ...
        await facade.query(AppConst.SET_FIGHTERS_PATH, {id:bf.id});
